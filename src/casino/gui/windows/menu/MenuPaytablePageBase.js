...
export class MenuPaytablePageBase extends MenuPageBase {
    ...
    _renderLines(canvas) {
        ...
        const dxLastLine = json.hasOwnProperty("step_x_for_last_line") ? json["step_x_for_last_line"] : 0;
        ...
        for (let i = 0; i < row; i++) {
            ...
            for (let j = 0; j < col; j++) {
                ...
                for (let k = 0; k < line.length; k++) {
                    point = OMY.Omy.add.spriteJson(canvas, json["active_point"] || json["active"]);
