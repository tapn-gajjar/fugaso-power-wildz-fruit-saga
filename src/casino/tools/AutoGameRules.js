...
//---------------------------------------
    ...
    startAutoGame(repeat = 10) {
        ...
        //Stay awake with the Screen when auto spin is working
        !this._noSleep.enabled && this._noSleep.enable();
    }
    ...
    stopAutoGame() {
        ...
        //Stay awake disable
        this._noSleep.enabled && this._noSleep.disable();
    }
