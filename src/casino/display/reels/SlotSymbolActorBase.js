...
export class SlotSymbolActorBase extends OMY.OContainer {
    constructor(reelIndex, reelParent, symbolIndex) {
        ...
        if (this._gdConf["debug"]) this._symbolS.alpha = 0.6;
        this._blurS = OMY.Omy.add.sprite(this, 0, 0);
    ...
    _blurState() {
        if (!this._isBlurred) {
            ...
            if (this.needBlur) {
                if (this._blurImgTimeOn) {
                    this._blurS.alpha = 0;
                    this._blurS.blurTween = OMY.Omy.add.tween(this._blurS, {alpha: this._blurImgAlpha}, this._blurImgTimeOn * this._turboCoef);
                    this._symbolS.blurTween = OMY.Omy.add.tween(this._symbolS, {alpha: 0}, this._blurImgTimeOn * this._turboCoef);
                }
            } else {
                this._blurS.alpha = 0;
            ...
            if (this._blurS.blurTween) {
                OMY.Omy.remove.tween(this._blurS);
                this._blurS.blurTween = null;
            }
            if (this._symbolS.blurTween) {
                OMY.Omy.remove.tween(this._symbolS);
                this._symbolS.blurTween = null;
            }
            if (this.needBlur) {
                this._blurS.alpha = 1;
        ...
        if (this._gdConf["blur"][this._symbolName]) this._blurS.texture = this._gdConf["blur"][this._symbolName];
    }
    ...
    setSymbol(sName = null) {
        if (sName != null) this._symbolName = sName;
        else this._symbolName = this.randomSymbol;
