...
export class ServerWorkBase extends PIXI.utils.EventEmitter {
    ...
    handleJoinResponse(e) {
        ...
        this._userName = e.data.nickname || "noname";
    }
    ...
    setToMinBet() {
        ...
        if (this._coinSystem) this._currentCoin = Number(this._coinValue[0]);
        this.currBet = this._possBets[0];
    }
    ...
    changeBet(way = 1, numLines = 0) {
        ...
        this.currBet = Number(this._possBets[betPosition]);
    }
    ...
    checkBet(setBet, save = false) {
        ...
        this.currBet = Number(this._possBets[setBet]);
    }
