...
export class IntroInfoWindow extends WindowsBase {
    ...
    _updateGameSize() {
       ...
       // }
        ...
        if (this.tint) {
            this.tint.x = -this.x;
            this.tint.y = -this.y;
            this.tint.width = OMY.Omy.WIDTH;
            this.tint.height = OMY.Omy.HEIGHT;
        }
    }
    ...
    _createGraphic() {
        ...
        this.tint = this.getChildByName("s_tint");
        ...
        if (this.getChildByName("c_page_layer").getChildByName("t_underReels")) {
            this.titleCanvas = this.getChildByName("c_page_layer").getChildByName("t_underReels");
            OMY.Omy.loc.addUpdate(this._onLocUpdate, this, false);
        }
    ...
    /**     * @private     */
    _onLocUpdate() {
        if (this.titleCanvas) this.titleCanvas.alignContainer();
